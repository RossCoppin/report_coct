...
The degree to which POM content dissolves into beach soil has been shown to be determined by the size of soil grains. The size of grains determines the amount of space available in between them. In other words, large grain sizes will have more space between them and ultimately more dissolved matter compared to fine grain beaches. Although grain size was fine between all the beaches in the study, no differences in size of grains was noted (personal observation). 
