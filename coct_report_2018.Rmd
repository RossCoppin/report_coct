...
```{r boxplot, fig.cap="Figure 2. Boxplots comparing POM and transect distance between cleared and non-cleared areas. The constituents of the box-and-whisker plots, and their interpretation, are described in the caption to Figure 1.", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
```{r, fig.cap="Figure 3. Boxplots comparing POM and transect length in cleared and non-cleared areas between sites. The constituents of the box-and-whisker plots, and their interpretation, are described in the caption to Figure 1", echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
